...
triggers. The $B$ decay vertex reconstruction (RECO) correction ensures that the simulation accurately 
...
%$B^0\to K^{*0}e^+e^-$ is analogously observed. 
...
leads to different results of $R_K$ and $R_{K^*}$ \cite{previous_RK}, \cite{previous_RK*}.
