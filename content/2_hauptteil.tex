...
\cite{angular_2} and branching fractions $\mathcal{B}(B^{(0,+)}\to K^{(+,*0)}l^+l^-)$ 
...
numerous analysis at LHCb, including the measurement of lepton universality in $b\to sll$ 
decays \cite{LHCb}.
...
\end{equation*}
After the selection of $m_\text{corr}$ all backgrounds with two or more missing hadrons 
...
The signal yield is then used to calculate the doubleratio using the definition
